...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Buscar el país al cual representa un atleta");
	...
	/**
	 * Le muestra el país al cual representa un atleta
	 */
	private void ejecutarPaisAtleta()
	{
		System.out.println("\n" + "Encontrar país al que un atleta representa" + "\n");
		...
		if (pais=="")
		{
			System.out.println("No se encontró ningún atleta con ese nombre");
		}
		else
		{
			System.out.println("El país al que pertenece el atleta "+nombreAtleta+" es "+pais+".");
		}
	}
