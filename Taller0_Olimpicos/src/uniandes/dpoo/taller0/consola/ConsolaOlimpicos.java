...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Buscar el pais de un atleta por su nombre");
	...
	/**
	 * Le muestra el usuario el pais de un atleta dado
	 */
	private void paisPorNombre()
	{
		String nombreAtleta = input("Por favor ingrese el nombre de un atleta");
		while (nombreAtleta.equals(""))
		{
			System.out.println("Ingresar un nombre de atleta no vacio");
			nombreAtleta = input("Por favor ingrese el nombre de un pais");
		}

		String pais = calculadora.paisPorNombre(nombreAtleta);
		if (pais.equals(""))
		{
			System.out.println("El atleta ingresado no fue encontrado en la base de datos");
		}
		else
		{
			System.out.println("El pais del atleta dado es: " +pais);
		}
